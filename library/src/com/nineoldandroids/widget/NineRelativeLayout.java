...
public class NineRelativeLayout extends RelativeLayout {
    private AnimatorProxy mProxy;

    public NineRelativeLayout(Context context) {
        super(context);
        mProxy = AnimatorProxy.wrap(this);
    }
    public NineRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mProxy = AnimatorProxy.NEEDS_PROXY ? AnimatorProxy.wrap(this) : null;
    }
    public NineRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
